...
> = {
  ...
  a1practice: {
    ...
    tagline: 'Single numbers precision drill across 20 to 12',
    duration: '10 min · Countdown',
    rules: [
      'Hit 2 out of 3 darts on each LARGE SINGLE FIELD of the numbers 20 to 12.',
      'Click on HIT if you hit 2 or 3 of the current number\'s LARGE SINGLE FIELD.',
      'Click MISS if you hit less than 2 (0 or 1 dart).',
      'Target numbers: 20 → 19 → 18 → 17 → 16 → 15 → 14 → 13 → 12 in order.',
      'Each target requires 3 successful visits to clear. Once you hit a number 3 times, you don\'t throw at it anymore!',
      'Clear all 9 numbers before the 10-minute timer expires!',
    ],
