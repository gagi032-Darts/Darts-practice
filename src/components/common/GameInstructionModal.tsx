...
> = {
  ...
  a1practice_top: {
    title: 'A1 Practice (20 to 11)',
    tagline: 'Upper board singles precision drill: 20 down to 11',
    duration: '10 min · Auto-rotates to 1–10',
    rules: [
      'Hit 2 out of 3 darts on each LARGE SINGLE FIELD from 20 down to 11.',
      'Click HIT if you hit 2 or 3 in the large single field.',
      'Click MISS if you hit less than 2 (0 or 1 dart).',
      'Each number requires 3 successful visits to clear.',
      'Auto-Rotation: If you clear all 10 targets in under 10 minutes, the game seamlessly switches to Numbers 1–10 for your remaining time!',
    ],
    proTip: 'Keep your release smooth and follow-through consistent on the top numbers.',
  },
  a1practice_bottom: {
    title: 'A1 Practice (1 to 10)',
    tagline: 'Lower board singles precision drill: 1 up to 10',
    duration: '10 min · Auto-rotates to 20–11',
    rules: [
      'Hit 2 out of 3 darts on each LARGE SINGLE FIELD from 1 up to 10.',
      'Click HIT if you hit 2 or 3 in the large single field.',
      'Click MISS if you hit less than 2 (0 or 1 dart).',
      'Each number requires 3 successful visits to clear.',
      'Auto-Rotation: If you clear all 10 targets in under 10 minutes, the game seamlessly switches to Numbers 20–11 for your remaining time!',
    ],
    proTip: 'Adjust your stance slightly for lower-board trajectory precision.',
  },
  bigsingles: {
    title: 'BIG SINGLES',
  ...
  bigsingles_intermediate: {
    ...
    tagline: 'Standard progression: 2 or 3 hits advance',
    duration: '10 min · Countdown',
    rules: [
      'Hit only the big single field of the current target number (1 to 20).',
      'Throw all 3 darts at the current target number each visit.',
      'Intermediate Level rules:',
      '• 2 or 3 hits: Move to next number (+1)',
      '• 1 hit: Stay on current number (0)',
      '• 0 hits: Go back one number (-1)',
      'Clear numbers 1 to 20 to finish a full round. New rounds loop until the 10-minute timer expires.',
    ],
    proTip: 'Aim right through the wide center portion of the large single wedge.',
  },
  bigsingles_advanced: {
    title: 'BIG SINGLES (Advanced)',
    tagline: 'Pro progression: 3 hits required to advance',
    duration: '10 min · Countdown',
    rules: [
      'Hit only the big single field of the current target number (1 to 20).',
      'Throw all 3 darts at the current target number each visit.',
      'Advanced Level rules:',
      '• 3 hits: Move to next number (+1)',
      '• 2 hits: Stay on current number (0)',
      '• 1 hit: Go back one number (-1)',
      '• 0 hits: Go back two numbers (-2)',
      'Clear numbers 1 to 20 to complete a full round. Loop as many rounds as possible in 10 minutes.',
    ],
    proTip: 'Focus on grouping: place the 2nd and 3rd darts right against the barrel of your first dart.',
  },
  rtwsingles: {
  ...
  rtwsingles_intermediate: {
    title: 'RTW Singles (Intermediate)',
    tagline: 'Miss 1 go back 1 · 3 misses in a row = Game Over',
    duration: '10 min · Countdown',
    rules: [
      'Throw at every single number from 1 to 20, ending with Bullseye.',
      'One dart per target (e.g. 1st visit: 1-2-3 if hitting).',
      '• Hit: Advance to next number (+1).',
      '• Miss: Go back to previous number (-1).',
      '• 3 misses in a row = Run Over (Start over immediately).',
      '• Bull Misses: Do not trigger losing strikes, but put you back to S20.',
      'Keep looping runs until the 10-minute session timer expires.',
    ],
    proTip: 'Don’t panic on a miss: focus cleanly on the step-back target to avoid 3 in a row!',
  },
  rtwsingles_advanced: {
    title: 'RTW Singles (Advanced)',
    tagline: 'Miss 1 go back 1 · 5 total misses = Game Over',
    duration: '10 min · Countdown',
    rules: [
      'Throw at every single number from 1 to 20, ending with Bullseye.',
      'One dart per target (e.g. 1st visit: 1-2-3 if hitting).',
      '• Hit: Advance to next number (+1).',
      '• Miss: Go back to previous number (-1).',
      '• 5 total misses in the run = Run Over (Start over immediately).',
      '• Bull Misses: Do not count towards the 5 misses limit, but reset target to S20.',
      'Clear Bullseye or restart upon 5 misses for 10 minutes.',
    ],
    proTip: 'Every dart is critical — maintain clean follow-through on every single number.',
  },
  bull: {
    title: 'Bull Warm-up',
