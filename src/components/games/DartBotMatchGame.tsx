...
export const DartBotMatchGame: React.FC<DartBotMatchGameProps> = ({
  ...
  return (
    <div className="w-full max-w-md sm:max-w-lg mx-auto flex flex-col space-y-2 sm:space-y-2.5 select-none">
      ...
      <div className="bg-[#121519] border border-[#232930] rounded-xl px-2.5 py-1 flex items-center justify-between shadow-xs text-xs font-mono">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="flex items-center gap-1 text-[11px] font-bold text-neutral-400 hover:text-white px-2 py-1 rounded-lg bg-[#1a1e24] border border-[#28303a] transition-all active:scale-95 cursor-pointer"
          >
        ...
        {matchMode === 'bot' ? (
          <div className="bg-[#1a1f26] border border-[#2c3540] rounded-lg px-2.5 py-1 flex items-center gap-2 font-bold shadow-xs">
          ...
          <div className="bg-[#1a1f26] border border-[#2c3540] rounded-lg px-2.5 py-1 flex items-center gap-1 font-bold shadow-xs text-xs">
      ...
      {matchMode === 'solo' ? (
        <>
          ...
          <div className="bg-[#121519] border border-[#232930] rounded-xl p-2.5 sm:p-3 text-center shadow-md relative overflow-hidden flex flex-col justify-between min-h-[105px] sm:min-h-[120px]">
          {/* Header Badges */}
          ...
          <div className="border-t border-[#232930] pt-1 mt-1 grid grid-cols-4 gap-1.5 text-center text-xs font-mono">
            <div className="bg-[#181d22] p-1 rounded border border-[#20272f]">
        ...
        {/* Solo Visit History Table (Scrollable, showing 4 visits in view) */}
        <div className="bg-[#121519] border border-[#232930] rounded-xl p-1.5 shadow-xs">
          ...
          <div
            ...
            className="space-y-1 pt-1 max-h-[118px] sm:max-h-[128px] overflow-y-auto overscroll-contain pr-1"
          >
            {allRows.map((row) => (
              <div
                key={row.roundIndex}
        ...
        <>
              ...
              <div className="flex items-center justify-between text-xs font-bold text-neutral-400 leading-none">
                <div className="flex items-center gap-1.5 text-white min-w-0">
                  ...
                  <PlayerAvatar
                    ...
                    size="sm"
                  />
                  <span className="text-xs text-white font-bold truncate max-w-[70px] sm:max-w-[100px]">
                ...
                <div className="h-4 flex items-center justify-center mt-1">
                  {playerCheckout ? (
                    <button
                      ...
                      className="text-xs font-bold font-mono text-emerald-300 hover:text-emerald-200 truncate cursor-pointer leading-none bg-emerald-950/60 border border-emerald-800/50 px-1.5 py-0.5 rounded"
                    >
                      {playerCheckout}
                    </button>
                  ) : (
            ...
            >
              ...
              <div className="flex items-center justify-between text-xs font-bold text-neutral-400 leading-none">
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  <div className="w-4.5 h-4.5 rounded-full bg-neutral-800 border border-neutral-700 flex items-center justify-center text-[10px] font-black text-neutral-300">
                    2
                  </div>
                  <span className="text-xs text-neutral-300 font-bold truncate max-w-[70px] sm:max-w-[100px]">
                    {levelInfo.name}
                  </span>
                </div>
              ...
              <div className="text-center my-1">
                ...
                <div className="h-4 flex items-center justify-center mt-1">
                  {isBotThrowing ? (
                    ...
                    <span className="text-xs font-bold font-mono text-rose-300 truncate leading-none bg-rose-950/60 border border-rose-800/50 px-1.5 py-0.5 rounded">
                      {botCheckout}
                    </span>
                  ) : (
                    <span className="text-[10px] text-neutral-500 font-medium leading-none">Scoring</span>
          ...
          {/* 3-Column Compact Visit History Table (Scrollable, showing 4 visits in view) */}
          <div className="bg-[#121519] border border-[#232930] rounded-xl p-1.5 shadow-xs">
            {/* Table Header */}
            <div className="grid grid-cols-3 text-center text-[10px] font-bold text-neutral-400 border-b border-[#232930] pb-1 leading-none uppercase tracking-wider">
                  ...
                  <div className="flex items-center justify-center gap-1.5">
                    {row.botScore !== undefined ? (
                      row.botIsBust ? (
                        ...
                        <span className="font-black text-rose-400 text-xs bg-rose-950/70 px-1.5 py-0.5 rounded border border-rose-700">
                          🎯 {row.botScore}
                        </span>
                      ) : (
                        <div className="flex items-baseline gap-1">
